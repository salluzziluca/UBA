...
Por ejemplo en el caso de un DataMiner que tiene que leer pdfs (con OCR) words (con texto) excel (celda por celda) y etc yo agarro y pongo todos los metodos comunes (openfile)
# Visitor
