...
## Paso a paso flujo
1. Ver los puntos por los que se mueve la curva, plantear una ecuacion que satisfaga esos puntos segun  el camino recorrido. 
2. Luego, esa funcion evaluarla en la $\vec F$ y resolver la integral