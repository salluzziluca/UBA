...
En mi caso no tome los tuits que no tienen hastags, pensando justamente en que se quiere analizar los diferentes hashtags por hora, ya que esto permite considerar diferentes tematicas
```js
[
  {
    $match: {
