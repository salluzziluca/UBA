...
$$E_{x}= \frac{-v_{i+1}-v_{i-1}}{(x_{i+1}-x_{i-1})}=-\frac{5,60 V- 6,39 V}{0,12m-0,010m} = 39,5 \frac{V}{m} $$
$$E_{x}= \frac{-v_{i+1}-v_{i-1}}{(y_{i+1}-y_{i-1})}=-\frac{6,62 V- 7,35 V}{0,11m-0,09m} = 36,5 \frac{V}{m} $$
$$\bar{E}(0,10m; 0,10 m) =30,5 \frac{V}{m} \hat{\imath}+36,5 \frac{V}{m} \hat{\jmath} $$
