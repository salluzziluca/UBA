...
$$E_{x}= \frac{v_{i-2}-4v_{i-1}-3v_{i}}{2(x_{i}-x_{i-1})}=\frac{3.2,56V + 4.10,62V-3.11,13V}{2(0,06m-0,05m)} = 48 \frac{V}{m} $$
$$E_{y}= \frac{-v_{i+2}+4v_{i+1}-3v_{i}}{2(y_{i+1}-y_{i})}=-\frac{9,94 V+ 4.10,55 V-3.11,13V}{2(0,06m-0,05m)} = 56,5 \frac{V}{m}$$
$$\bar{E}(0,05m; 0,05 m) =48\frac{V}{m} \hat{\imath}+56,5 \frac{V}{m} \hat{\jmath} $$
