...
Sea U ∈ R^n×n con n = 2 ó n = 3 y consideremos la transformación lineal T(x) := Ux.

Entonces:
Diremos que T es una rotación si det(U) = 1.
Diremos que T es una simetría ortogonal respecto del subespacio S si T(v) = v para todo v ∈ S y T(v) = −v para todo v ∈ S⊥.